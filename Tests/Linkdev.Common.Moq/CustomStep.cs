...
namespace Linkdev.Common.Moq
{
    class CustomStep
    {
        static void Main(string[] args)
        {
            ...
            Guid PrimaryEntityID = new Guid("B1402196-A8EA-EE11-A204-6045BDA18D51");
            string PrimaryEntitySchemaName = /*"task";//*/ "phonetocaseprocess";   /*"contact";  */
            ...
            Activity activity = new LinDev.MOHU.Utilites.DeleteInstanceForDefaultBPF();
    ...
    class Credential
    {
        ...
        public const string UserName = @"crm20160\crmadmin";
        public const string Password = "linkP@ss";
        public const string Url = "http://geainternalcrm.linkdev.com/GEA3/XRMServices/2011/Organization.svc";
        // "https://geainternalcrm.linkdev.com/GEA/XRMServices/2011/Organization.svc";
