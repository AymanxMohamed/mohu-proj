...
using LinkDev.MOHU.Plugin.Utilites;
...
namespace Linkdev.Common.Moq
{
    class plugin
    {
        static void Main(string[] args)
        {
            ...
            Guid PrimaryEntityID = new Guid("a2487435-e8e9-ee11-904d-6045bda18d51");
            string PrimaryEntityName = "phonetocaseprocess";
           ...
           // IOrganizationService service = GetCrmConnection("https://stc-dev-v9.linkdev.com/XRMServices/2011/Organization.svc", @"CRM365DC\crmadmin", "linkP@ss");
            ...
            OnCreateBPFInstance mapTransactionOnTicketCreation = new OnCreateBPFInstance();
