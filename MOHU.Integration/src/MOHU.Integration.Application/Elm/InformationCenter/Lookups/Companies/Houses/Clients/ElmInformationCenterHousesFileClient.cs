...
internal class ElmInformationCenterHousesFileClient : IElmInformationCenterHousesClient
{
    private const string FilePath = "Files/Elm/InformationCenter/Lookups/Applicants/Data/houses.json";
    ...
    private static ErrorOr<ElmInformationCenterResponseRoot<List<ElmHouseResponse>>?> GetDataFromSource()
    {
        ...
        try
        {
            ...
            return JsonConvert.DeserializeObject<ElmInformationCenterResponseRoot<List<ElmHouseResponse>>>(data);
        }
        catch (Exception ex)
        {
