...
{
    public class ChangeBpfInstanceStage : CustomStepBase
    {
        ...
        public override void ExtendedExecute()
        {
            ...
            else
            {
                ...
                ChangeBpfInstanceBll.ChangeBPFProcessStage(Context.PrimaryEntityId, Context.PrimaryEntityName, moveToNextStage, backToPreviousStage, moveToSpecificStage, processStage);
