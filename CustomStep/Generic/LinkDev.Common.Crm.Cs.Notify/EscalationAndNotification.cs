...
{
    public class EscalationAndNotification : CustomStepBase
    {
        ...
        public InArgument<EntityReference> Task { get; set; }
        ...
        public override void ExtendedExecute()
        {
            ...
            if (notificationType != NotificationType.Null)
            {
                ...
                sendNotificationBll.SendEsclationOrNotificationToQueue(
                    fromWhom, 
